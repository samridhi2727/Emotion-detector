...
st.set_page_config(
    page_title="Live Emotion Detector",
    layout="centered",
...
st.markdown("""
    ...
    <div class="vibe-header">
        ...
        <div class="vibe-subtitle">-By Samridhi <br> Welcome to Vibe Check AI which analyse both Real time and Textual emotions and tries to uplift your mood by jokes. Login to begin. Sign Up if you are a new user!</div>
    </div>
""", unsafe_allow_html=True)
...
if st.session_state.get("page_mode") in ["Real-Time Emotion Detector", "Text Emotion Detector"]:
    return_clicked = st.sidebar.button("🔙Mode Selection", key="return_mode")
    if return_clicked:
        st.session_state["page_mode"] = None
        st.rerun()
            ...
            if filtered_results:
                ...
                for emotion, prob in filtered_results:
                    ...
                    speak_str = (
                        ...
                        f"Here is a joke to lift up your mood: {joke}. hope you Have a great day ahead"
                    )
